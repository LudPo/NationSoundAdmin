 ...
 */
final class Version20240205175744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, location_category_id INT NOT NULL, latitude NUMERIC(10, 7) NOT NULL, longitude NUMERIC(11, 7) NOT NULL, location_icon VARCHAR(255) DEFAULT NULL, INDEX IDX_5E9E89CB4937AA6 (location_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
